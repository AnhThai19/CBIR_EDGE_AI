...
Mô hình sử dụng MobileNetV3-Small làm backbone và được huấn luyện bằng Triplet Loss để học vector đặc trưng cho bài toán tìm kiếm ảnh.
...
Để triển khai mô hình trên thiết bị di động, mô hình PyTorch được chuyển sang TensorFlow Lite.
